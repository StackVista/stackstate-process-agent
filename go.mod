...
replace github.com/DataDog/datadog-agent v0.0.0-20230307121454-9e9c7904ced5 => github.com/StackVista/datadog-agent-upstream-for-process-agent v0.0.0-20230607095704-55b2dcd1e590 // stac-19417-http-tracing-id
