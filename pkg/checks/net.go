...
func (c *ConnectionsCheck) formatConnections(conns []common.ConnectionStats, lastConns map[string]common.ConnectionStats, lastCheckTime time.Time) []*pkg.Connection {
...
func batchConnections(cfg *config.AgentConfig, groupID int32, cxs []*pkg.Connection) []model.MessageBody {
