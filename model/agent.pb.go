...
type Pod struct {
	...
	Pids      []uint32          `protobuf:"varint,5,rep,packed,name=pids,proto3" json:"pids,omitempty"`
}
...
type Connection struct {
	...
	KubeNamespace          string              `protobuf:"bytes,57,opt,name=kubeNamespace,proto3" json:"kubeNamespace,omitempty"`
	KubePod                string              `protobuf:"bytes,58,opt,name=kubePod,proto3" json:"kubePod,omitempty"`
}
...
func (m *Connection) GetKubeNamespace() string {
	if m != nil {
...
func (m *Connection) GetKubePod() string {
	if m != nil {
		return m.KubePod
	}
	return ""
...
var fileDescriptor_56ede974c0020f77 = []byte{
	...
	,
}
...
func (m *Connection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	if len(m.KubePod) > 0 {
		i -= len(m.KubePod)
		copy(dAtA[i:], m.KubePod)
		i = encodeVarintAgent(dAtA, i, uint64(len(m.KubePod)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xd2
	}
	if len(m.KubeNamespace) > 0 {
		i -= len(m.KubeNamespace)
		copy(dAtA[i:], m.KubeNamespace)
		i = encodeVarintAgent(dAtA, i, uint64(len(m.KubeNamespace)))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xca
...
func (m *Connection) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 57:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KubeNamespace", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KubeNamespace = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		case 58:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field KubePod", wireType)
			}
			var stringLen uint64
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.KubePod = string(dAtA[iNdEx:postIndex])
			iNdEx = postIndex
		default:
			iNdEx = preIndex
			skippy, err := skipAgent(dAtA[iNdEx:])
