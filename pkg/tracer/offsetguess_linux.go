...
/*
#include "../../tracer-ebpf/tcptracer-bpf.h"
*/
import "C"
...
// guess expects elf.Module to hold a stackstate-process-agent object and initializes the
...
func guess(b *elf.Module) error {
	...
	// it and try again.
	// See https://github.com/weaveworks/stackstate-process-agent/issues/24
