...
gofmt -l $REPLACE_MODE -r '"process_config.process_dd_url" -> "sts_url"' $REPLACE_SCOPE
gofmt -l $REPLACE_MODE -r '"error parsing process_dd_url: %s" -> "error parsing sts_url: %s"' $REPLACE_SCOPE
gofmt -l $REPLACE_MODE -r '"dd_agent_py" -> "sts_agent_py"' $REPLACE_SCOPE
gofmt -l $REPLACE_MODE -r '"dd_agent_py_env" -> "sts_agent_py_env"' $REPLACE_SCOPE
