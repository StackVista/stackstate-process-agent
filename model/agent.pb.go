...
const (
	TraceDirection_request  TraceDirection = 0
	TraceDirection_response TraceDirection = 1
	TraceDirection_both     TraceDirection = 2
)

var TraceDirection_name = map[int32]string{
	0: "request",
	1: "response",
	2: "both",
}

var TraceDirection_value = map[string]int32{
	"request":  0,
	"response": 1,
	"both":     2,
}
...
func (x TraceDirection) String() string {
	return proto.EnumName(TraceDirection_name, int32(x))
}
...
func (m *CollectorConnections) GetPods() []*Pod {
	if m != nil {
		return m.Pods
	}
	return nil
...
type ProcessStat struct {
	...
	ContainerState ContainerState `protobuf:"varint,11,opt,name=containerState,proto3,enum=stackstate.process_agent.ContainerState" json:"containerState,omitempty"`
...
type HTTPTraceObservation struct {
	LatencySec     float64        `protobuf:"fixed64,1,opt,name=latencySec,proto3" json:"latencySec,omitempty"`
	TraceDirection TraceDirection `protobuf:"varint,2,opt,name=traceDirection,proto3,enum=stackstate.process_agent.TraceDirection" json:"traceDirection,omitempty"`
	TraceId        []byte         `protobuf:"bytes,3,opt,name=traceId,proto3" json:"traceId,omitempty"`
	Method         HTTPMethod     `protobuf:"varint,4,opt,name=method,proto3,enum=stackstate.process_agent.HTTPMethod" json:"method,omitempty"`
	Response       int32          `protobuf:"varint,5,opt,name=response,proto3" json:"response,omitempty"`
}

func (m *HTTPTraceObservation) Reset()         { *m = HTTPTraceObservation{} }
func (m *HTTPTraceObservation) String() string { return proto.CompactTextString(m) }
func (*HTTPTraceObservation) ProtoMessage()    {}
func (*HTTPTraceObservation) Descriptor() ([]byte, []int) {
	return fileDescriptor_56ede974c0020f77, []int{22}
}
func (m *HTTPTraceObservation) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *HTTPTraceObservation) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_HTTPTraceObservation.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *HTTPTraceObservation) XXX_Merge(src proto.Message) {
	xxx_messageInfo_HTTPTraceObservation.Merge(m, src)
}
func (m *HTTPTraceObservation) XXX_Size() int {
	return m.Size()
}
func (m *HTTPTraceObservation) XXX_DiscardUnknown() {
	xxx_messageInfo_HTTPTraceObservation.DiscardUnknown(m)
}

var xxx_messageInfo_HTTPTraceObservation proto.InternalMessageInfo

func (m *HTTPTraceObservation) GetLatencySec() float64 {
	if m != nil {
		return m.LatencySec
	}
	return 0
...
func (m *HTTPTraceObservation) GetTraceDirection() TraceDirection {
	if m != nil {
		return m.TraceDirection
	}
	return TraceDirection_request
}

func (m *HTTPTraceObservation) GetTraceId() []byte {
	if m != nil {
		return m.TraceId
	}
	return nil
...
func (m *HTTPTraceObservation) GetMethod() HTTPMethod {
	if m != nil {
		return m.Method
	}
...
func (m *HTTPTraceObservation) GetResponse() int32 {
	if m != nil {
		return m.Response
	}
	return 0
...
type Connection struct {
	...
	Natladdr            *Addr                   `protobuf:"bytes,55,opt,name=natladdr,proto3" json:"natladdr,omitempty"`
	Natraddr            *Addr                   `protobuf:"bytes,56,opt,name=natraddr,proto3" json:"natraddr,omitempty"`
	HttpObservations    []*HTTPTraceObservation `protobuf:"bytes,57,rep,name=httpObservations,proto3" json:"httpObservations,omitempty"`
	NetNs               uint32                  `protobuf:"varint,58,opt,name=netNs,proto3" json:"netNs,omitempty"`
	InitialSeq          uint32                  `protobuf:"varint,59,opt,name=initialSeq,proto3" json:"initialSeq,omitempty"`
	InitialAckSeq       uint32                  `protobuf:"varint,60,opt,name=initialAckSeq,proto3" json:"initialAckSeq,omitempty"`
}
...
func (m *Connection) GetNatladdr() *Addr {
	if m != nil {
		return m.Natladdr
	}
	return nil
...
func (m *Connection) GetNatraddr() *Addr {
	if m != nil {
		return m.Natraddr
	}
	return nil
...
func (m *Connection) GetHttpObservations() []*HTTPTraceObservation {
	if m != nil {
		return m.HttpObservations
	}
	return nil
}
...
func (m *Connection) GetInitialSeq() uint32 {
	if m != nil {
		return m.InitialSeq
	}
	return 0
...
func (m *Connection) GetInitialAckSeq() uint32 {
	if m != nil {
		return m.InitialAckSeq
	}
	return 0
}
...
func init() {
	...
	proto.RegisterEnum("stackstate.process_agent.TraceDirection", TraceDirection_name, TraceDirection_value)
	proto.RegisterEnum("stackstate.process_agent.HTTPMethod", HTTPMethod_name, HTTPMethod_value)
	...
	proto.RegisterType((*CollectorCommands)(nil), "stackstate.process_agent.CollectorCommands")
	proto.RegisterType((*Pod)(nil), "stackstate.process_agent.Pod")
	proto.RegisterMapType((map[string]string)(nil), "stackstate.process_agent.Pod.LabelsEntry")
	...
	proto.RegisterType((*CollectorCommand)(nil), "stackstate.process_agent.CollectorCommand")
	...
	proto.RegisterType((*ConnectionMetricValue)(nil), "stackstate.process_agent.ConnectionMetricValue")
	proto.RegisterType((*ConnectionMetric)(nil), "stackstate.process_agent.ConnectionMetric")
	proto.RegisterMapType((map[string]string)(nil), "stackstate.process_agent.ConnectionMetric.TagsEntry")
	proto.RegisterType((*HTTPTraceObservation)(nil), "stackstate.process_agent.HTTPTraceObservation")
...
var fileDescriptor_56ede974c0020f77 = []byte{
	...
	,
}
...
func (m *Pod) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	_ = l
	if len(m.Pids) > 0 {
		dAtA10 := make([]byte, len(m.Pids)*10)
		var j9 int
		...
		i = encodeVarintAgent(dAtA, i, uint64(j9))
		i--
		dAtA[i] = 0x2a
	}
	if len(m.Labels) > 0 {
...
func (m *HTTPTraceObservation) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *HTTPTraceObservation) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *HTTPTraceObservation) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
	if m.Response != 0 {
		i = encodeVarintAgent(dAtA, i, uint64(m.Response))
		i--
		dAtA[i] = 0x28
	}
	if m.Method != 0 {
	...
	if len(m.TraceId) > 0 {
		...
		i = encodeVarintAgent(dAtA, i, uint64(len(m.TraceId)))
		i--
		dAtA[i] = 0x1a
	}
	if m.TraceDirection != 0 {
		i = encodeVarintAgent(dAtA, i, uint64(m.TraceDirection))
		i--
		dAtA[i] = 0x10
	}
	if m.LatencySec != 0 {
		i -= 8
		encoding_binary.LittleEndian.PutUint64(dAtA[i:], uint64(math.Float64bits(float64(m.LatencySec))))
		i--
		dAtA[i] = 0x9
	}
	return len(dAtA) - i, nil
...
func (m *Connection) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	...
	var l int
	_ = l
	if m.InitialAckSeq != 0 {
		i = encodeVarintAgent(dAtA, i, uint64(m.InitialAckSeq))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xe0
	...
	if m.InitialSeq != 0 {
		i = encodeVarintAgent(dAtA, i, uint64(m.InitialSeq))
		i--
		dAtA[i] = 0x3
		i--
		dAtA[i] = 0xd8
	...
	if len(m.HttpObservations) > 0 {
		for iNdEx := len(m.HttpObservations) - 1; iNdEx >= 0; iNdEx-- {
			{
				size, err := m.HttpObservations[iNdEx].MarshalToSizedBuffer(dAtA[:i])
				if err != nil {
					return 0, err
				}
				i -= size
	...
	if m.Natraddr != nil {
		{
			size, err := m.Natraddr.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
	...
	if m.Natladdr != nil {
		{
			size, err := m.Natladdr.MarshalToSizedBuffer(dAtA[:i])
			if err != nil {
				return 0, err
			}
			i -= size
...
func (m *HTTPTraceObservation) Size() (n int) {
	if m == nil {
		return 0
	}
	var l int
	...
	if m.TraceDirection != 0 {
		n += 1 + sovAgent(uint64(m.TraceDirection))
	}
	l = len(m.TraceId)
	if l > 0 {
		n += 1 + l + sovAgent(uint64(l))
	...
	if m.Response != 0 {
		n += 1 + sovAgent(uint64(m.Response))
	}
	return n
}
...
func (m *Connection) Size() (n int) {
	...
	if len(m.HttpObservations) > 0 {
		for _, e := range m.HttpObservations {
			l = e.Size()
			n += 2 + l + sovAgent(uint64(l))
		}
	}
	...
	if m.InitialSeq != 0 {
		n += 2 + sovAgent(uint64(m.InitialSeq))
	}
	if m.InitialAckSeq != 0 {
		n += 2 + sovAgent(uint64(m.InitialAckSeq))
	}
	return n
}
		...
		case 5:
			if wireType == 0 {
				...
				if elementCount != 0 && len(m.Pids) == 0 {
					m.Pids = make([]int32, 0, elementCount)
				}
				for iNdEx < postIndex {
					var v int32
					for shift := uint(0); ; shift += 7 {
...
func (m *HTTPTraceObservation) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: HTTPTraceObservation: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: HTTPTraceObservation: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 1 {
				return fmt.Errorf("proto: wrong wireType = %d for field LatencySec", wireType)
			}
			var v uint64
			if (iNdEx + 8) > l {
				return io.ErrUnexpectedEOF
			...
			v = uint64(encoding_binary.LittleEndian.Uint64(dAtA[iNdEx:]))
			iNdEx += 8
			m.LatencySec = float64(math.Float64frombits(v))
		case 2:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field TraceDirection", wireType)
			}
			m.TraceDirection = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.TraceDirection |= TraceDirection(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
...
func (m *Connection) Unmarshal(dAtA []byte) error {
	...
	for iNdEx < l {
		...
		case 55:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Natladdr", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Natladdr.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 56:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field Natraddr", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			if err := m.Natraddr.Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 57:
			if wireType != 2 {
				return fmt.Errorf("proto: wrong wireType = %d for field HttpObservations", wireType)
			}
			var msglen int
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
			...
			m.HttpObservations = append(m.HttpObservations, &HTTPTraceObservation{})
			if err := m.HttpObservations[len(m.HttpObservations)-1].Unmarshal(dAtA[iNdEx:postIndex]); err != nil {
				return err
			}
			iNdEx = postIndex
		case 58:
		...
		case 59:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialSeq", wireType)
			}
			m.InitialSeq = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InitialSeq |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
		case 60:
			if wireType != 0 {
				return fmt.Errorf("proto: wrong wireType = %d for field InitialAckSeq", wireType)
			}
			m.InitialAckSeq = 0
			for shift := uint(0); ; shift += 7 {
				if shift >= 64 {
				...
				b := dAtA[iNdEx]
				iNdEx++
				m.InitialAckSeq |= uint32(b&0x7F) << shift
				if b < 0x80 {
					break
				}
			}
