...
func formatUser(fp *process.FilledProcess) *pkg.ProcessUser {
	return &pkg.ProcessUser{
		Name: fp.Username,
	}
}

func formatCPU(fp *process.FilledProcess, t2, t1, syst2, syst1 cpu.TimesStat) *pkg.CPUStat {
